...
/// Tampilkan dialog update. Return true kalau proses install dimulai.
...
class _UpdateDialogState extends State<_UpdateDialog> {
  ...
  void _startUpdate() {
    ...
    try {
      _sub = OtaUpdate()
          .execute(widget.info.url, destinationFilename: 'apkabsensi-update.apk')
